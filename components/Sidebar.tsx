...
*/
import { useSettings, useUI, useTools } from '../lib/state';
    ...
    <>
      <aside className={c('sidebar', { open: isSidebarOpen })}>
        ...
        <div className="sidebar-content">
          ...
          <div className="sidebar-section">
            <h4 className="sidebar-section-title">Remote Monitoring</h4>
            <div className="remote-settings">
              <label className="checkbox-label">
                <input 
                  type="checkbox" 
                  checked={isWatchingRemote} 
                  onChange={(e) => setIsWatchingRemote(e.target.checked)}
                />
                Watch Remote Transcriptions
              </label>
              <label>
                Filter by Meeting ID (Optional)
                <input 
                  type="text" 
                  value={remoteMeetingId} 
                  onChange={(e) => setRemoteMeetingId(e.target.value)}
