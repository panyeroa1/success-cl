...
// FIX: Refactored to use composition over inheritance for EventEmitter to resolve 'emit', 'on', and 'off' property errors
export class GenAILiveClient {
  ...
  // FIX: Use an internal EventEmitter instance for event management
  private emitter = new EventEmitter<LiveClientEventTypes>();

  // FIX: Expose on and off methods by binding to the internal emitter
